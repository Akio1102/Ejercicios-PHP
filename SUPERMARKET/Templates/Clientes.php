          ...
          <tbody class="" id="tabla">
            ...
            ?> 
              <tr>
                ...
                <td> <?= $val["compania"] ?> </td>
                <td>
                  <a class="btn btn-outline-danger" href="../Controllers/Clientes/borrarClientes.php?clienteId=<?=$val['clienteId']?>&req=delete">
                  <i class="bi bi-trash3"></i>Borrar</a>
                </td>
                <td>
                  <a class="btn btn-outline-warning" href="../Controllers/Clientes/actualizarClientes.php?clienteId=<?=$val['clienteId']?>">
