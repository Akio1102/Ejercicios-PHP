...
class Productos extends ConexiónPdo{
    ...
    public function insertData(){
        try {
            $stm = $this-> dbCnx -> prepare("INSERT INTO productos(nombre,telefono,ciudad) 
    ...
    public function delete(){
        try {
            $stm = $this-> dbCnx -> prepare("DELETE FROM productos WHERE proveedorId = :id");
    ...
    public function selectOne(){
        try {
            $stm = $this-> dbCnx -> prepare("SELECT * FROM productos WHERE proveedorId = :id");
            $stm->bindParam(":id",$this->proveedorId);
            $stm -> execute();
            return $stm -> fetchAll();
        } catch (Exception $e) {
    ...
    public function update(){
        try {
            $stm = $this-> dbCnx -> prepare("UPDATE productos SET nombre=:nomb , telefono=:tel , ciudad=:city
